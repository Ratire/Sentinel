...
//Date        : Sun Mar  8 04:20:22 2026
//Host        : archlinux running 64-bit Arch Linux
//Command     : generate_target FFT512_System.bd
//Design      : FFT512_System
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "FFT512_System,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=FFT512_System,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "FFT512_System.hwdef" *) 
module FFT512_System
   ();
  ...
  wire [17:0]fft512_axishim_0_fft_datain;
  wire fft512_axishim_0_fft_valin;
  wire [63:0]fft512_axishim_0_m_axis_TDATA;
  wire fft512_axishim_0_m_axis_TLAST;
  wire fft512_axishim_0_m_axis_TREADY;
  wire fft512_axishim_0_m_axis_TVALID;
  wire [0:0]rst_ps8_0_96M_peripheral_aresetn;
  wire [0:0]rst_ps8_0_96M_peripheral_reset;
  wire [53:0]sentinel_fft512_reor_0_data_out;
  wire sentinel_fft512_reor_0_val_out;
  ...
  FFT512_System_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps8_0_96M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(fft512_axishim_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(fft512_axishim_0_m_axis_TLAST),
        .s_axis_s2mm_tready(fft512_axishim_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(fft512_axishim_0_m_axis_TVALID));
  FFT512_System_axi_smc_0 axi_smc
  ...
  FFT512_System_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_96M_peripheral_aresetn));
  FFT512_System_fft512_axishim_0_1 fft512_axishim_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .fft_datain(fft512_axishim_0_fft_datain),
        .fft_dataout(sentinel_fft512_reor_0_data_out),
        .fft_valin(fft512_axishim_0_fft_valin),
        .fft_valout(sentinel_fft512_reor_0_val_out),
        .m_axis_tdata(fft512_axishim_0_m_axis_TDATA),
        .m_axis_tlast(fft512_axishim_0_m_axis_TLAST),
        .m_axis_tready(fft512_axishim_0_m_axis_TREADY),
        .m_axis_tvalid(fft512_axishim_0_m_axis_TVALID),
        .rst(rst_ps8_0_96M_peripheral_reset),
        .s_axis_tdata(axi_dma_0_M_AXIS_MM2S_TDATA),
        .s_axis_tready(axi_dma_0_M_AXIS_MM2S_TREADY),
        .s_axis_tvalid(axi_dma_0_M_AXIS_MM2S_TVALID));
  FFT512_System_rst_ps8_0_96M_0 rst_ps8_0_96M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  FFT512_System_sentinel_fft512_reor_0_0 sentinel_fft512_reor_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .data_in(fft512_axishim_0_fft_datain),
        .data_out(sentinel_fft512_reor_0_data_out),
        .rst(rst_ps8_0_96M_peripheral_reset),
        .val_in(fft512_axishim_0_fft_valin),
        .val_out(sentinel_fft512_reor_0_val_out));
  FFT512_System_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp0_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARADDR),
        ...
        .maxigp0_aruser(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARUSER),
        ...
        .maxigp0_awuser(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWUSER),
